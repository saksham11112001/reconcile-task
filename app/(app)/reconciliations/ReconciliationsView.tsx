...
interface Props {
  ...
  myMode?:       boolean   // true → pre-filter to "mine"
}

export function ReconciliationsView({ list, clients, currentUserId, myMode = false }: Props) {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10,
        ...
        {/* Mine / All toggle */}
        <div style={{ display: 'flex', gap: 0, borderRadius: 8,
        ...
        <select value={clientFilter} onChange={e => setClientFilter(e.target.value)}
          className="input"
          style={{ fontSize: 13, padding: '5px 10px', maxWidth: 200, flex: '0 0 auto' }}>
              ...
              {filtered.map(r => {
                ...
                return (
                  <tr key={r.id} style={{ borderBottom: '1px solid var(--border-light)' }}>
                    ...
                    <td style={{ padding: '0.65rem 1rem', fontSize: 12.5, color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>
