        ...
        <div style={{ display: 'flex', borderRadius: 8, border: '1px solid var(--border)', overflow: 'hidden' }}>
          <button
            ...
            style={{ padding: '5px 10px', border: 'none', cursor: 'pointer',
              background: viewMode === 'list' ? 'var(--surface-subtle)' : 'var(--surface)',
          ...
          <button
            ...
            style={{ padding: '5px 10px', border: 'none', cursor: 'pointer',
              background: viewMode === 'board' ? 'var(--surface-subtle)' : 'var(--surface)',
              color: viewMode === 'board' ? 'var(--brand)' : 'var(--text-muted)',
              display: 'flex', alignItems: 'center', gap: 4, fontSize: 12 }}>
            <LayoutGrid style={{ width: 13, height: 13 }}/> Board
          </button>
        </div>

        {/* Inline / Modal toggle — only in list view */}
        {viewMode === 'list' && (
          <div style={{ display: 'flex', borderRadius: 8, border: '1px solid var(--border)', overflow: 'hidden' }}>
